...
public class Ticket extends Entry {
	//private data--number sold is the amount of tickets that have been currently sold
	private int numsold;
	//fast pass is a type of ticket that allows you to go on all the rides but you do not need to wait as long on the line
	...
	//getter that returns the number sold
	public int getNumSold() {
		return numsold;
	}
	//getter that returns the price of a regular ticket
	public int getTixPrice() {
		return regTix;
	}
	//getter that returns the price of a fast pass
	public int getFPPrice() {
		return fastPass;
	}
	//setter that sets how many tickets have currently been sold
